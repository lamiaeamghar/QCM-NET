    ...
    <div class="relative h-screen flex items-center">
        <div class="container text-center">
            <div class="error-image">
                <img src="/images/others/error-404.png" alt="Not Found Image">
            </div>
            ...
            <button class="bg-primary text-base text-white px-10 py-3 font-semibold rounded transition-all hover:text-heading hover:bg-secondary" @click="$router.go(-1)">
