...
import nuxt_plugin_plugin_34fceac8 from 'nuxt_plugin_plugin_34fceac8' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_image_d3217034 from 'nuxt_plugin_image_d3217034' // Source: .\\image.js (mode: 'all')
...
import nuxt_plugin_popover_34bf45b0 from 'nuxt_plugin_popover_34bf45b0' // Source: ..\\plugins\\popover.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"EduMall","titleTemplate":"EduMall - %s","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"EduMall blog template"},{"name":"format-detection","content":"telephone=no"},{"name":"keywords","content":"EduMall blog template"},{"name":"app-mobile-web-app-title","content":"EduMall"},{"name":"application-name","content":"EduMall blog template"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"},{"rel":"apple-touch-icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"},{"rel":"stylesheet","href":"https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_34fceac8 === 'function') {
    await nuxt_plugin_plugin_34fceac8(app.context, inject)
  }

  if (typeof nuxt_plugin_image_d3217034 === 'function') {
    await nuxt_plugin_image_d3217034(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_popover_34bf45b0 === 'function') {
    await nuxt_plugin_popover_34bf45b0(app.context, inject)
  }
