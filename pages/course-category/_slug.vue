<template>
	<div class="category-wrapper">
		...
		<div class="featured-course py-section">
			<div class="container">
				<div class="section-title mb-7 -mt-3">
		...
		<div class="Instructors-area py-section overflow-hidden">
			<div class="container">
				<div class="section-title mb-10">
					<h2 class="-mt-2.5 text-2xl md:text-[28px]"><mark class="bg-transparent relative inline-block before:content-titleShape before:absolute before:-bottom-5 before:left-1/2 before:-translate-x-1/2 before:-z-10">Popular</mark> Instructors</h2>
				</div>
				<swiper
