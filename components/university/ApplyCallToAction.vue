			...
			<div class="grid grid-cols-12">
				<div class="col-span-12 lg:col-span-5">
					<div class="text-center">
						<img
							src="/images/about/home-university-about-image-02.jpg"
							alt=""
							class="md:max-w-[calc(1170px_-_((40_*_1170px)_/_100))] z-10 relative"
						>
					</div>
				</div>
				<div class="col-span-12 lg:col-span-7">
					<div class="bg-[#F4F9FF] rounded -mt-5 lg:mt-15 pt-12 pb-10 lg:pb-24">
						<div class="lg:max-w-[340px] md:ml-7.5 lg:ml-auto lg:mr-16 text-center md:text-left px-2 sm:px-5 md:px-0">
							...
							<n-link
								to="/"
								class="text-base px-9 py-3.5 font-medium bg-secondary rounded inline-block hover:text-white hover:bg-primary"
							>Learn more about admissions</n-link>
						</div>
					</div>
				</div>
			</div>
