<template>
	<div class="partner-section">
		<div class="custom-container">
			<div class="grid grid-cols-12 lg:gap-10 border-t-[1px] border-t-gallery py-section">
				<div class="col-span-12 lg:col-span-3">
					<SectionTitleStyleOne
						class="mb-10"
						title="Who Will You Learn"
						highlight-title="With"
						sub-title="You can list your partners or instructors's brands here to show off your site's reputation"
					/>
					...
					<div class="partner-logo-wrapper group mt-12 lg:mt-0">
						<swiper :options="swiperOptions">
							<div
								...
								class="swiper-slide"
							>
								<div class="flex justify-center items-center group-hover:opacity-40 hover:!opacity-100 transition-all">
									<img
										:src="partner.logo"
										:alt="partner.name"
									>
