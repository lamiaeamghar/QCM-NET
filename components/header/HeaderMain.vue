<template>
	<div class="header-main relative py-5 md:py-2.5 bg-white shadow-[0_10px_26px_rgba(0,0,0,.05)]" :class="{ '!fixed top-0 left-0 w-full bg-white z-50 transition-all shadow-md animate-fadeInDown xl:!py-0' : isSticky }">
		<div class="container">
			<div class="flex items-center justify-between">
				...
				<div class="header-inner flex items-center justify-end flex-grow">
					...
					<div class="header-user relative hidden lg:flex items-center pl-5 ml-5 xl:pl-8 xl:ml-8 before:contents-[] before:absolute before:w-[1px] before:h-8 before:bg-[#d9dee3] before:top-1/2 before:left-0 before:-translate-y-1/2">
						<div class="px-2.5">
							<n-link
								to="/login"
						...
						<div class="px-2.5">
							<n-link
								to="/register"
								class="text-sm font-semibold text-primary inline-block px-7 py-3 leading-none bg-[#0071dc]/10 rounded hover:bg-primary hover:text-white transition-all"
							>Sign Up</n-link>
						</div>
					</div>
